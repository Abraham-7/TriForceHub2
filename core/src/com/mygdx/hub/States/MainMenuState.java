...
import com.mygdx.hub.TbMenu;
import com.mygdx.hub.TbText;

/**
 * Created by Abraham on 2015-12-03.
 */
public class MainMenuState extends HubUpdate implements Screen, InputProcessor {
    ...
    public MainMenuState(HubUpdate hubUpdate){ //References the main class.
    ...
    public void render(float delta) {
        ...
        if(TbPlay.isPressed()){ //When you click the Play Button, it sets the screen to the Play Screen.
            hubUpdate.setScreen(new PlayState(hubUpdate));
        }
    }
